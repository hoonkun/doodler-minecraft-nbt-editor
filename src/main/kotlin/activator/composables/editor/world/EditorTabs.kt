...
import activator.doodler.editor.Editor
import activator.composables.global.ThemedColor.Companion.selectable
...
fun ColumnScope.EditorTabs(
    ...
    DoodlerLogger.recomposition("EditorTabs")
...
fun EditorTab(
    ...
    DoodlerLogger.recomposition("EditorTab")
